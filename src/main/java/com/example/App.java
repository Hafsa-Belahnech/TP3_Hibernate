...
public class App {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("\n_Test des relations & des opérations en cascade_");
            testRelationsEtCascade(emf);

            // Test de la suppression orpheline
            System.out.println("\n_Test de la suppression orpheline_");
            testSuppressionOrpheline(emf);

            // Test de la relation ManyToMany avec Équipement
            System.out.println("\n_Test de la relation ManyToMany avec Équipement_");
            testRelationManyToMany(emf);

        } finally {
            // On Ferme l'EntityManagerFactory
            emf.close();
        }
    }
    ...
    private static void testRelationsEtCascade(EntityManagerFactory emf) {
        ...
        try {
            ...
            Utilisateur utilisateur = new Utilisateur("Salma", "Bahi", "salma.bahi@example.com");

            // Création d'une salle
            Salle salle = new Salle("Salle A10", 40);
    ...
    private static void testSuppressionOrpheline(EntityManagerFactory emf) {
        ...
        try {
            ...
            Utilisateur utilisateur = new Utilisateur("Ahmed", "Ahjami", "ahmad.ahjami@example.com");

            Salle salle1 = new Salle("Salle B12", 20);
            em.persist(salle1);

            Salle salle2 = new Salle("Salle C13", 15);
            em.persist(salle2);
    ...
    private static void testRelationManyToMany(EntityManagerFactory emf) {
        ...
        try {
            ...
            // Création des salles
            Salle salleReunion = new Salle("Salle de réunion D14", 25);
            Salle salleFormation = new Salle("Salle de formation E25", 40);
